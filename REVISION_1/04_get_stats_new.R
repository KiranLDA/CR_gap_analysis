...
# orders
length(unique(indexes$order[!duplicated(indexes$taxon_name)])) #38
# genera
...
# Families
length(unique(iucn_banked_recalcitrance$family[!duplicated(iucn_banked_recalcitrance$taxon_name)])) #238
# orders
