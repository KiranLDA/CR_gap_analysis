...
# iucn_wcvp_matched$banked = ifelse(iucn_wcvp_matched$taxon_name %in% brahms_unique_wcvp_matched$taxon_name,TRUE,FALSE)
# length(which(iucn_wcvp_matched$banked == T))
